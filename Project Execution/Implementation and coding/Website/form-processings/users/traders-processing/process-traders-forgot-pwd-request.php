...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['email']) and isset($_POST['pwdResetRequestBtn'])) {
        ...
        if (!empty($user)) {
            ...
            'http://localhost/the-clechuderfax-e-chain/form-processings/users/process-pwd-request-verification.php?type=trader&email=$email&token=$token'
            ";
                ...
                header("location: ../../../users/traders/traders-forgot-password.php");
                exit();
            }
        } else {
