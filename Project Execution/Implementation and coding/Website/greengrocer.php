...
// page specific query
$allProductQuery = "SELECT * FROM PRODUCTS WHERE PRODUCT_CATEGORY_ID = 3";

$paginationQuery = "SELECT * FROM (
            SELECT
            products.*,
            row_number() over (ORDER BY product_id ASC) line_number
            FROM products WHERE product_category_id = 3
...
<?php require_once "./partials/nav-partial.php"; ?>
    ...
    <section class="hero relative">
        ...
        <ul class="shop-nav-link centered">
            ...
            <li class="nav-item link-separator">/</li>
            <li class="nav-item">
                <a class="nav-link active">Greengrocer</a>
            </li>
        </ul>
    </section>
            ...
            <div class="product-filter">
                ...
                <div class="product-categories">
                    ...
                    <ul class="categories-list">
                        ...
                        <li class="category-item">
                            <a class="category-link">Greengrocer</a>
                        </li>
                        <li class="category-item">
