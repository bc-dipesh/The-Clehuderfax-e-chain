    ...
    <div class="container">
        <div class="signup-content">
            <div class="signup-form">
                ...
                <h2 class="form-title">Trader Sign up</h2>

                <!--customer signup form-->
                <form action="../../form-processings/users/traders-processing/process-traders-sign-up-form.php"
            ...
            <div class="signup-image">
                ...
                <a href="./traders-sign-in.php" class="signup-image-link">I am already member</a>
