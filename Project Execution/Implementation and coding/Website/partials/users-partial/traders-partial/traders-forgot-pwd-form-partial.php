    ...
    <div class="container">
        ...
        <div class="signin-content">
            <div class="signin-image">
                ...
                <a href="../../users/traders/traders-sign-in.php" class="signup-image-link">Back to Login</a>
            </div>

            <div class="signin-form">
                <h2 class="form-title">Password reset request</h2>
                <form action="../../form-processings/users/traders-processing/process-traders-forgot-pwd-request.php"
